...
def msb_parquet(msbfile,paramfile):
...
#a = clean_text('msbsignal7.txt','msbsignal7cleaned.txt')
    ...
    df1 = pd.read_csv(a,names=['particle_multiplicity' ,'transverse_momenta_sum' ,'beam_thrust'])
    print(df1.head())
    #os.chdir("../")
    file3 =  paramfile + '.txt'
...
#dataset
'''dfs7 = msb_parquet('msbsignal7', 'signal7var')
dfb7 =msb_parquet('msbbackground7','background7var')
df1 = to_parquet_1(dfs7,dfb7,'msbvar7')'''


#dataset
'''dfs69 = msb_parquet('msbsignal69', 'signal69var')
dfb69 =msb_parquet('msbbackground69','background69var')
df2 = to_parquet_1(dfs69,dfb69,'msbvar69')'''


#dataset
dfs1 = msb_parquet('msbsignal1', 'signal1var')
dfb2 =msb_parquet('msbbackground2','background2var')
df1_2 = to_parquet_1(dfs1,dfb2,'msbvar1_2')
